...
MIDI_DIR   = "/mnt/d/flbeat/data/melody_corpus"   # clean monophonic phonk melodies
MODEL_DIR  = "/mnt/d/flbeat/data/models/phonk_amt_melody"
...
EPOCHS      = 2      # clean monophonic melody corpus (1498 files); 2 epochs is plenty
LR          = 1e-5
