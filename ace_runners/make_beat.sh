...
# MIOpen env fixes the intermittent WSL conv bug ("Invalid elapsed time")
export LD_LIBRARY_PATH=/opt/rocm/lib HSA_ENABLE_SDMA=0 MIOPEN_FIND_MODE=2 MIOPEN_DEBUG_CONV_IMMED_FALLBACK=1
